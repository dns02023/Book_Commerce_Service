...
//    // 서비스는 레포지토리를 사용하므로, Autowired로 주입해준다.
//    // 필드 주입 방법 => 단점 : 바꿀 수가 없음. 즉, test 등에서 바꿔가며 할 수가 없다.
//    @Autowired
//    private MemberRepository memberRepository;
//
//    // setter 주입 방법 => 장점 : test 수행 시 가짜 레포지토리 주입 가능, 단점 : 실무에서는 이미 어플리케이션 조립이 끝난 후 setter를 쓸일이 없다.
...
//    }
    ...
    // autowired 어노테이션 안해줘도, 생성자가 하나만 존재하는 경우 자동으로 주입해준다.
    // lombok 어노테이션으로 지정하면 생성자 생략가능
    @Autowired // 생략 가능
